...
namespace CnpjApi
{
    public class ConsultaService : IConsultaService
    {
        ...
        public async Task<CnpjResult> ConsultarCnpjAsync(string cnpj, string Tcnpj, string Tordem, string Tdv)
        {
            try
            {
                ...
                {
                    _logger.LogInformation($" CNPJ {cnpj} from cache");
                    return cachedResult;
                }
                ...
                if (cnpj.Length > 8)
                {
                    ...
                    Tcnpj = cnpj.Substring(0, 8); 
                    Tordem = cnpj.Substring(8, 4); 
                    Tdv = cnpj.Substring(12, 2); 
                ...
                var sql = @"
                    ...
                    WHERE A.CNPJ = @Tcnpj and A.ORDERM=@Tordem and A.DV = @Tdv";
